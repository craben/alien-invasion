...
class Scoreboard():
    ...
    def prep_high_score(self):
        ...
        score_high_str = 'Max ' + '{:,}'.format(rounded_high_score)
        self.high_score_image = self.font.render(score_high_str, True, self.text_color, self.ai_settings.bg_color)
